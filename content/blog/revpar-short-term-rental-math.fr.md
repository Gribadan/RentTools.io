...
locale: fr
title: "RevPAR : la mesure que votre taux d'occupation cache"
excerpt: Le taux d'occupation et l'ADR ne disent chacun que la moitié de l'histoire. Le RevPAR — revenu par nuit disponible — les réconcilie. Trois objets décortiqués.
status: published
tags:
...
- Comptez les **nuits disponibles**, pas les nuits calendaires — retirez les nuits bloquées pour vous-même ou pour des travaux, sinon le RevPAR sous-estime votre travail de tarification.
- Le test du seuil de rentabilité : **occupation d'équilibre = RevPAR actuel ÷ prix par nuit envisagé.** Si vous la franchissez quand même, augmentez le prix.
- Au-dessus d'environ 90 % d'occupation, vous êtes presque sûrement trop bon marché. Montez le prix jusqu'à ce que l'occupation se cale vers 75–80 % et regardez le RevPAR grimper.
- Ne comparez le RevPAR qu'entre périodes comparables — janvier avec janvier, pas avec juillet.
...
| Objet | ADR | Occupation | Nuits réservées | Revenu d'hébergement | RevPAR |
|---|---|---|---|---|---|
| A — « toujours plein » | 96 $ | 88 % | 26,4 | 2534 $ | 84,48 $ |
| B — « festin ou famine » | 158 $ | 61 % | 18,3 | 2891 $ | 96,38 $ |
| C — « le discret » | 124 $ | 74 % | 22,2 | 2753 $ | 91,76 $ |
...
Pour la mécanique du déplacement du prix sur la semaine et sur la saison plutôt qu'en un chiffre plat, [la tarification dynamique pour la location courte durée](/blog/dynamic-pricing-short-term-rental) va plus loin. Le RevPAR, c'est le tableau d'affichage ; la tarification dynamique, c'est la façon de jouer.
