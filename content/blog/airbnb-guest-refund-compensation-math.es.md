...
locale: es
title: "Reembolso al huésped de Airbnb: cuánto compensar cuando una estancia sale mal"
excerpt: Una fórmula para reembolsos durante la estancia: noches afectadas × precio por noche × factor de gravedad. Cuatro escenarios con cifras y las reglas de las plataformas que anulan una oferta tacaña.
status: published
tags:
...
- **Un reembolso voluntario casi siempre sale más barato que uno impuesto.** La política de reubicación y reembolso de Airbnb puede reembolsar al huésped *y* cobrarle a usted el coste de reubicarlo.
- Los plazos son ajustados: el huésped tiene **72 horas** para señalar un problema y usted tiene **72 horas** para responder a una solicitud en el centro de resolución antes de que Airbnb intervenga.
- **Lo pequeño se compensa, lo real se reembolsa, el vale solo vale para huéspedes directos.** Un bono de 40 $ para una cena salva la reseña; un descuento en una estancia futura no significa nada para un huésped de paso llegado por una plataforma.
- Quedarse corto cuesta dos veces: la plataforma anula su cifra *y* la gestión lenta y tacaña aparece en la reseña.
...
| Gravedad | Factor | Qué cubre |
|---|---|---|
| Cosmética | 0–5 % | Bombilla fundida, falta un filtro de café, un cajón que atasca. Reponer y disculparse; el dinero rara vez hace falta. |
| Menor | 5–15 % | Wifi lento, una de dos teles averiada, el lavavajillas no arranca. Molesto, pero no define la estancia. |
| Moderada | 15–35 % | Sin agua caliente media jornada, una nevera que se calienta, obras nocturnas tras la pared. |
| Mayor | 40–60 % | Aire averiado en ola de calor, sin agua caliente un día entero, sucio a la llegada, un servicio clave (piscina, cocina) inutilizable. |
| Inhabitable | 100 % | Sin calefacción en invierno, sin luz, sin agua, inundación, riesgo para la seguridad. El huésped no puede quedarse. |
...
| Escenario | Precio por noche | Noches afectadas | Gravedad | Reembolso |
|---|---|---|---|---|
| Bombilla fundida + faltan filtros | 140 $ | 3 | 0 % | 0 $ (reponer) |
| Sin agua caliente una mañana, resuelto a las 13 | 150 $ | 0,25 | 25 % | ≈ 9 $ → redondear a 40 $ de gesto |
| Aire averiado en ola de calor, 2 de 3 noches | 185 $ | 2 | 55 % | ≈ 204 $ |
| Caldera muerta en invierno, el huésped se reubica la noche 2 | 160 $ | 2 | 100 % | 320 $ + diferencia de reubicación |
