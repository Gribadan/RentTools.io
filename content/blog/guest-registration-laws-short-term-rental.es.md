...
locale: es
title: "Registro de viajeros en alquiler vacacional: guía país por país"
excerpt: Qué datos de viajeros deben recoger y comunicar a las autoridades los Anfitriones de alquiler vacacional en la UE — España, Italia, Francia, Portugal, Alemania.
status: published
tags:
  - gdpr:GDPR
...
- **Italia** funciona con Alloggiati Web — datos del viajero a la Polizia di Stato en **24 horas** tras la llegada, más el nuevo código CIN en cada anuncio.
- **Francia, Portugal y Alemania** son más livianas: un formulario en papel o digital que rellena el viajero, guardado por usted y mostrado a la policía a petición — sin envío proactivo.
- Su base legal para todo esto es la **obligación legal**, no el consentimiento. Un viajero no puede negarse al registro y quedarse igualmente.
- El verdadero riesgo del Anfitrión no es la multa — es una escalada de la plataforma o un anuncio bloqueado cuando falta un número de registro.

## Dos leyes que tiran en sentidos opuestos

Si ha leído [nuestra guía del RGPD para Anfitriones](/blog/gdpr-for-vacation-rental-hosts), todo el espíritu de ese reglamento es la minimización: recoja los menos datos posibles, consérvelos el menor tiempo posible, bórrelos a petición.
...
1. **Un reloj de conservación corto, por país.** España dice tres años; Alemania dice un año y luego destruir. Si publica en ambos, no le vale una carpeta con una sola regla. Etiquete cada escaneo con su jurisdicción y su fecha de borrado.
2. **Un paso de borrado real.** «Entregar a la policía» no es «guardar para siempre». Cuando pasan los tres años españoles, el escaneo es puro riesgo — bórrelo. El peor patrón es la carpeta de WhatsApp con pasaportes de hace cuatro años hasta cuyo final nadie baja.
3. **Un sistema, no cinco bandejas de correo.** Si un viajero presenta una solicitud de acceso del RGPD, usted debe poder decir exactamente qué tiene y dónde. Cinco carpetas de correo y un carrete de fotos no son una respuesta. Por eso justamente [RentTools](/onboard) guarda los documentos de los viajeros en un solo sitio con un botón de exportación — la ley de registro multiplica su pila de documentos, y una pila que no puede buscar es una pila que no puede defender.
