...
locale: de
title: "Airbnb-Rückerstattung: wie viel Sie erstatten, wenn der Aufenthalt schiefgeht"
excerpt: Eine Formel für Rückerstattungen mitten im Aufenthalt: betroffene Nächte × Nachtpreis × Schweregrad. Vier durchgerechnete Szenarien und die Plattformregeln, die ein zu niedriges Angebot überstimmen.
status: published
tags:
  - host-tips:Hosting-Tipps
...
- **Eine freiwillige Rückerstattung ist fast immer günstiger als eine erzwungene.** Airbnbs Richtlinie für Umbuchung und Rückerstattung kann dem Gast erstatten *und* Ihnen die Kosten für seine Umbuchung in Rechnung stellen.
- Die Fristen sind eng: Gäste haben **72 Stunden**, um ein Problem zu melden, Sie haben **72 Stunden**, um auf eine Anfrage im Lösungscenter zu antworten, bevor Airbnb eingreift.
- **Kleines kompensieren, Echtes erstatten, Gutschrift nur für Direktgäste.** Ein Restaurant-Gutschein über 40 $ rettet die Bewertung; ein Rabatt auf einen künftigen Aufenthalt bedeutet einem einmaligen Plattformgast nichts.
- Zu niedrig anzusetzen kostet doppelt: Die Plattform überstimmt Ihre Zahl, *und* die langsame, knausrige Bearbeitung taucht in der Bewertung auf.
...
Hosts behandeln eine Rückerstattung während des Aufenthalts als zu minimierenden Verlust, und genau dieser Rahmen lässt sie überzahlen. Die Rückerstattung ist nicht die Kosten. Die Kosten sind die festgesetzte Zahl plus die Bewertung plus die Stunde, die Sie um eine Zahl gefeilscht haben, die Sie in dreißig Sekunden hätten berechnen können. Rechnen Sie die Formel in dem Moment, in dem das Problem landet, bieten Sie das Ergebnis an, bevor der Gast fragt, und runden Sie zur Beziehung hin auf, wenn die Mathematik kalt herauskommt. Sie zahlen weniger Bargeld und behalten mehr Sterne als der Host, der dagegen kämpfte. Die günstigste Rückerstattung ist die schnelle, faire, die Sie zuerst angeboten haben — und wenn Sie wollen, dass auch der Rest Ihres Betriebs auf Zahlen statt auf Nerven läuft, [beginnen Sie dort, wo Kalender und Geld an einem Ort zusammenlaufen](/onboard).
