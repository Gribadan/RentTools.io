...
locale: es
title: "Sobreventa: lo que cuesta de verdad reubicar a un huésped"
excerpt: Cuando no puede honrar una reserva, reubicar al huésped significa pagar la diferencia de precio de un alojamiento equivalente, no solo reembolsar.
status: published
tags:
...
- Reubicar a un huésped significa alojarlo en un alojamiento **equivalente o mejor** y pagar la diferencia de precio, no solo reembolsar.
- La política de reubicación de Booking.com hace al **anfitrión responsable de la diferencia de precio más el transporte razonable**; si no lo resuelve usted, lo hace su equipo y se lo factura.
- En Airbnb una cancelación del lado del anfitrión **acumula penalizaciones**: tarifa del 10/25/50 % (con tope de 1.000 $), fechas bloqueadas, una reseña automática y riesgo para el estatus Superhost.
- La factura escala con la **escasez**: en temporada baja ronda los ~100 $; un fin de semana de evento puede superar el valor de la reserva original.
- Reubicar a mitad de una estancia larga es lo peor: sustituye las **noches restantes a precio premium** y muda a un huésped que ya se instaló.
- La prevención (sincronizar calendarios, un día buffer) cuesta casi 0; una sola reubicación evitada la amortiza durante años.
...
| Escenario | Reserva original | Coste del sustituto | Diferencia de precio | Transporte | Gesto comercial | Factura de reubicación |
|---|---|---|---|---|---|---|
| Temporada baja, misma ciudad | 4 noches x 90 $ = 360 $ | 4 x 115 $ = 460 $ | 100 $ | 15 $ | 0 $ | **115 $** |
| Fin de semana de evento, escaso | 2 noches x 150 $ = 300 $ | 2 x 280 $ = 560 $ | 260 $ | 40 $ | 50 $ | **350 $** |
| A mitad de reserva de 28 noches | 18 noches restantes x 80 $ = 1.440 $ | 18 x 110 $ = 1.980 $ | 540 $ | 120 $ | 200 $ | **860 $** |
...
Una reubicación de temporada baja cuesta ~115 $. Una de fin de semana de evento ~350 $. Ahora ponga precio a la prevención: mantener los calendarios sincronizados es gratis, un [día buffer](/blog/cleaning-buffer-days) cuesta una noche de ingresos unas pocas veces al año, y la [auditoría 24 h antes de la llegada](/blog/avoiding-double-bookings) cuesta 30 segundos por reserva. El coste anual esperado de una sincronización bien hecha para un anfitrión pequeño es, en esencia, los ingresos de día buffer a los que renuncia — y eso solo si usa buffers.
