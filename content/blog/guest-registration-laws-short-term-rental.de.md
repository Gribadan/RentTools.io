...
locale: de
title: "Gästemeldepflicht bei Kurzzeitvermietung: ein Länder-Leitfaden"
excerpt: Welche Gästedaten Kurzzeitvermieter in der EU erheben und an Behörden melden müssen — Spanien, Italien, Frankreich, Portugal, Deutschland: Fristen und Aufbewahrung.
status: published
tags:
  - gdpr:DSGVO
...
- **Italien** läuft über Alloggiati Web — Gästedaten an die Polizia di Stato innerhalb von **24 Stunden** nach Ankunft, dazu der neue CIN-Code auf jedem Inserat.
- **Frankreich, Portugal, Deutschland** sind leichter: ein Papier- oder Digitalformular, das der Gast ausfüllt, bei Ihnen abgelegt und der Polizei auf Anfrage gezeigt wird — keine proaktive Übermittlung.
- Ihre Rechtsgrundlage für all das ist die **rechtliche Verpflichtung**, nicht die Einwilligung. Ein Gast kann die Meldung nicht verweigern und trotzdem bleiben.
- Das eigentliche Risiko des Gastgebers ist nicht die Geldbuße — es ist eine Eskalation der Plattform oder ein gesperrtes Inserat, wenn eine Registriernummer fehlt.

## Zwei Gesetze, die in entgegengesetzte Richtungen ziehen

Wenn Sie [unseren DSGVO-Leitfaden für Gastgeber](/blog/gdpr-for-vacation-rental-hosts) gelesen haben, ist der ganze Geist dieser Verordnung Minimierung: erheben Sie so wenig Daten wie möglich, behalten Sie sie so kurz wie möglich, löschen Sie auf Anfrage.
...
| Land | System | Frist | Aufbewahrung | Upload oder Aufbewahren |
|------|--------|-------|--------------|-------------------------|
| Spanien | SES.HOSPEDAJES | 24 h ab Check-in | 3 Jahre | Upload |
| Italien | Alloggiati Web | 24 h ab Ankunft | Nach Polizeivorgabe | Upload |
| Frankreich | Fiche de police | Bei Ankunft | 6 Monate | Aufbewahren und vorzeigen |
| Portugal | SIBA boletim | 3 Werktage | Nach SIBA-Vorgabe | Upload |
| Deutschland | Meldeschein | Bei Ankunft | 1 Jahr | Aufbewahren und vorzeigen |
...
3. **Ein System, nicht fünf Postfächer.** Stellt ein Gast einen DSGVO-Auskunftsantrag, müssen Sie genau sagen können, was Sie wo halten. Fünf E-Mail-Ordner und eine Handy-Galerie sind keine Antwort. Genau deshalb hält [RentTools](/onboard) Gästedokumente an einem Ort mit Export-Knopf — das Meldegesetz vervielfacht Ihren Dokumentenstapel, und ein Stapel, den Sie nicht durchsuchen können, ist ein Stapel, den Sie nicht verteidigen können.
