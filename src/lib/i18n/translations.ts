...
export const translations = {
  ...
  "cleaning.afterGuest": { en: "Full day after {name} checkout", ru: "Полный день после выезда {name}" },
  "cleaning.afterGuestQuick": { en: "After {name} checkout", ru: "После выезда {name}" },
  "cleaning.beforeGuest": { en: "Full day before {name} checkin", ru: "Полный день перед заездом {name}" },
