...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: { en: "Cleaners", ru: "Уборщики" }, href: "/dashboard/admin/workspace/cleaners" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: { en: "Scheduled jobs", ru: "Задачи" }, href: "/dashboard/admin/operations/scheduled-jobs" },
  ...
  },
  {
    ...
    items: [
      { label: { en: "Blog posts", ru: "Статьи блога" }, href: "/dashboard/admin/content/blog-posts", requiresSuperadmin: true },
      ...
      { label: { en: "Feedback", ru: "Обратная связь" }, href: "/dashboard/admin/content/feedback", requiresSuperadmin: true },
      { label: { en: "Blog media", ru: "Медиа блога" }, href: "/dashboard/admin/content/blog-media", requiresSuperadmin: true },
      { label: { en: "Guest form templates", ru: "Шаблоны анкет" }, href: "/dashboard/admin/content/guest-forms" },
    ],
  },
];
