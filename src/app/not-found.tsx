  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#111113] p-6">
      <div className="w-full max-w-md text-center">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#1e1e22]">
        ...
        <h1 className="mb-2 text-3xl font-bold tracking-tight text-[#e8e8ec]">404</h1>
