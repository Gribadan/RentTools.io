...
const COPY: Record<Locale, CopyBlock> = {
  ...
  ru: {
    hero: {
      ...
      subtitleA: "Соединяем ваши календари в",
      platforms: "Airbnb, Booking.com, Vrbo",
      subtitleB: "и любых других, где есть iCal. Каждая платформа видит чужие брони —",
      subtitleC: "двойные бронирования становятся редкостью",
      subtitleD: ". Бесплатно навсегда, с открытым кодом.",
      cta: "Начать бесплатно",
      ctaNote: "Без карты. Никаких платных тарифов. Можно попробовать без регистрации.",
    },
    how: {
      eyebrow: "Как это работает",
      title: "Три шага. Большинство справляется за семь минут.",
      steps: [
        {
          title: "Скопируйте iCal-URL с каждой платформы",
          body: "У Airbnb он в Calendar → Sync calendars → Export. У Booking.com — в Calendar → Sync calendars. У Vrbo похоже. Вставьте URL в нашу форму.",
        },
        {
          title: "Получите объединённый фид",
          body: "Один iCal-URL под каждую платформу: чужие брони, ваши ручные записи и буферные дни на уборку. Без двойных бронирований.",
        },
        {
          title: "Вставьте наш URL обратно в каждую",
          body: "Airbnb и Booking.com подтягивают наш фид раз в несколько часов. Теперь их календари знают друг о друге и о ваших ручных блокировках.",
        },
      ],
      tryWizard: "Попробовать без регистрации",
    },
    features: {
      eyebrow: "Решает то, что действительно мешает",
      titleA: "Всё, что нужно хосту.",
      titleB: "Ничего лишнего.",
      items: [
        {
          title: "Кросс-платформенная синхронизация",
          body: "Раз в 10 минут подтягиваем iCal каждой платформы и переиздаём его для остальных. Airbnb видит брони Booking и наоборот — та же защита, что даёт платный channel manager, только бесплатно и с открытым кодом.",
        },
        {
          title: "Автоматизация уборок",
          body: "Буферные дни, которые платформы не умеют делать сами. Дневной список уборок. Роль уборщика — отдельный доступ, без лишнего.",
        },
        {
          title: "Сколько угодно объектов в одной панели",
          body: "Управляйте всеми объектами из одной точки. Переключение по горячей клавише. У соведущих и уборщиков — свои роли с нужным доступом.",
        },
        {
          title: "Шаблоны сообщений",
          body: "Шаблоны под каждый объект с переменными (имя гостя, заезд, wifi). В буфер обмена — и сразу в Airbnb или WhatsApp.",
        },
        {
          title: "Публичный iCal-фид",
          body: "У каждого объекта свой URL. Вставьте его обратно в Airbnb или Booking — они подхватят ваши ручные блокировки.",
        },
        {
          title: "Поиск гостей по Cmd-K",
          body: "Найдите любого прошлого гостя по всем объектам одной горячей клавишей. С экспортом документов — на случай, когда нужно сдать в МВД или отчёт.",
        },
      ],
    },
    compatible: {
      label: "Совместимо с",
      footer: "…и с любой платформой, у которой есть iCal-экспорт.",
    },
    trust: {
      open: {
        title: "Открытый исходный код",
        body: "Лицензия MIT на GitHub. Читайте код, открывайте issue или поднимите у себя на любом $4 дроплете.",
        link: "Посмотреть на GitHub",
      },
      gdpr: {
        title: "GDPR-совместимо",
        body: "Одна служебная cookie сессии. Никакой аналитики, рекламы, трекеров. Удаляете аккаунт — данные пропадают вместе с ним.",
      ...
      items: [
        {
          ...
          a: "Сильно снижает риск — не до нуля, но близко. iCal каждой платформы мы подтягиваем раз в 10 минут и переиздаём для остальных: Airbnb узнаёт о брони на Booking (и наоборот) примерно за 10 минут. Сами платформы обновляют импортированные фиды раз в 2–12 часов. API в реальном времени был бы быстрее, но Airbnb и Booking.com не продают свои channel-manager API частным хостам — только сертифицированным PMS за $100–300 в месяц за то же самое. Для 99% небольших хостов обмена через iCal хватает с запасом.",
        },
        {
          q: "Это правда бесплатно?",
          a: "Да. Наша размещённая версия бесплатна для личного использования, с лимитом запросов на аккаунт, чтобы счета не разрослись. Исходники — под MIT: клонируйте, запустите на $4 дроплете, никому ничего не должны.",
        },
        {
          q: "Что он реально делает?",
          a: "Подтягивает любой iCal-совместимый календарь — Airbnb, Booking.com, Vrbo и всё, что отдаёт URL экспорта. Хватит скакать по вкладкам. Добавляет буферные дни на уборку, которых сами платформы делать не умеют. Делает дневной список уборок. Шаблоны сообщений с привязкой к объекту, поиск гостей по Cmd-K — сразу по всем.",
        },
        {
          q: "Обязательно поднимать у себя?",
          a: "Нет. Зарегистрируйтесь и пользуйтесь нашей версией. Если когда-нибудь перерастёте бесплатный лимит или захотите полный контроль над данными — экспортируйте и поднимите у себя. Ваш выбор.",
        },
        {
          q: "Где хранятся данные гостей?",
          a: "В одном SQLite-файле на нашем сервере. Никаких сторонних обработчиков, кроме Google Gemini — и то только на момент распознавания паспорта. Удаляете аккаунт — данных не остаётся.",
        },
      ],
    },
    finalCta: {
      ...
      titleB: "Для хостов.",
      body: "Без платных тарифов. Без допродаж. Без трекинга. Мы сами платим за хостинг, чтобы вы занимались гостями, а не вкладками браузера.",
