...
export default async function HomePage() {
  ...
  return (
    <div className="editorial min-h-screen flex flex-col">
      ...
      {/* ─────────────── Header — shared with /onboard, /blog, /blog/[slug]
            so chrome stays visually identical across every public surface
            (px, py, brand mark, nav order, max-w). Previous inline copy
            had px-6 only; MarketingHeader is px-4 sm:px-6 — that 16px
            mobile delta was the source of the cross-page nudge. ─────── */}
      <MarketingHeader />
