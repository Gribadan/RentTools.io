...
`;
  ...
  const migrations = [
    ...
    `ALTER TABLE "Property" ADD COLUMN "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP`,
    `ALTER TABLE "Reservation" ADD COLUMN "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP`,
